...
def ann_model_result():
    ...
    """)
    st.image("training_validation_loss.png")  # Replace with the correct path to your image
    st.code("""
    ...
    """)
    st.image("standardized_predictions.png")  # Replace with the correct path to your image
    st.code("""
    ...
    """)
    st.image("original_scale_predictions.png")  # Replace with the correct path to your image
    st.code("""
    ...
    """)
    st.image("test_results.png")  # Replace with the correct path to your image
    st.code("""
    ...
    """)
    st.image("train_results.png")  # Replace with the correct path to your image
    st.code("""
    from sklearn.metrics import mean_squared_error, mean_absolute_error, r2_score
    from math import sqrt
